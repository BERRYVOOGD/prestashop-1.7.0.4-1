                    Bitnami PrestaShop Stack 1.7.0.4-1
                  ==============================
...
bitnami-prestashop-1.7.0.4-1-linux-installer.run on Linux or
bitnami-prestashop-1.7.0.4-1-linux-x64-installer.run on Linux 64 bit or
bitnami-prestashop-1.7.0.4-1-windows-installer.exe on Windows or
bitnami-prestashop-1.7.0.4-1-osx-x86-installer.dmg on OS X x86.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-prestashop-1.7.0.4-1-linux.run
...
From this screen you can also install Beetailer, which is a service that allows
you to integrate your store into Facebook. This will work only if your server has
a publicly accesible IP address.
...
in /home/user/prestashop-1.7.0.4-1 on Linux or C:\Bitnami\Bitnami PrestaShop Stack
on Windows or /Applications/prestashop-1.7.0.4-1 on OS X and that you use port 8080 
...
/home/user/prestashop-1.7.0.4-1/apache2/logs/error.log on Linux or
C:\Bitnami\Bitnami PrestaShop Stack\apache2\logs\error.log on Windows or
/Applications/prestashop-1.7.0.4-1/apache2/logs/error.log.
