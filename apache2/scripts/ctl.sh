...
HTTPD_PIDFILE=/Applications/prestashop-1.7.0.4-1/apache2/logs/httpd.pid



HTTPD="/Applications/prestashop-1.7.0.4-1/apache2/bin/httpd -f /Applications/prestashop-1.7.0.4-1/apache2/conf/httpd.conf"
if [ -f "/Applications/prestashop-1.7.0.4-1/apps/bitnami/banner/disable-banner" ] ; then
...
. /Applications/prestashop-1.7.0.4-1/apache2/bin/envvars
