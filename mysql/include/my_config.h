...
#define DEFAULT_MYSQL_HOME "/Applications/prestashop-1.7.0.4-1/mysql"
#define SHAREDIR "/Applications/prestashop-1.7.0.4-1/mysql/share"
#define DEFAULT_BASEDIR "/Applications/prestashop-1.7.0.4-1/mysql"
#define MYSQL_DATADIR "/Applications/prestashop-1.7.0.4-1/mysql/data"
#define DEFAULT_CHARSET_HOME "/Applications/prestashop-1.7.0.4-1/mysql"
#define PLUGINDIR "/Applications/prestashop-1.7.0.4-1/mysql/lib/plugin"
#define DEFAULT_SYSCONFDIR "/Applications/prestashop-1.7.0.4-1/mysql/etc"
