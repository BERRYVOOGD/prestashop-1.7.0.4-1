...
if ('/Applications/prestashop-1.7.0.4-1/php/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/Applications/prestashop-1.7.0.4-1/php/lib/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
